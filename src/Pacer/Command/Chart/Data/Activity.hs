...
instance
  ...
  LabelOptic "atype" k (SomeActivityKey a) (SomeActivityKey a) x y
  where
  labelOptic =
    lens
      (\(MkSomeActivityKey a) -> a ^. #atype)
      (\(MkSomeActivityKey a) b -> MkSomeActivityKey (set' #atype b a))
...
instance
  ...
  LabelOptic "datetime" k (SomeActivityKey a) (SomeActivityKey a) x y
  where
  labelOptic =
    lens
      (\(MkSomeActivityKey a) -> a ^. #datetime)
      (\(MkSomeActivityKey a) b -> MkSomeActivityKey (set' #datetime b a))
...
instance
  ...
  LabelOptic "duration" k (SomeActivityKey a) (SomeActivityKey a) x y
  where
  labelOptic =
    lens
      (\(MkSomeActivityKey a) -> a ^. #duration)
      (\(MkSomeActivityKey a) b -> MkSomeActivityKey (set' #duration b a))
...
instance
  ...
  LabelOptic "labels" k (SomeActivityKey a) (SomeActivityKey a) x y
  where
  labelOptic =
    lens
      (\(MkSomeActivityKey a) -> a ^. #labels)
      (\(MkSomeActivityKey a) b -> MkSomeActivityKey (set' #labels b a))
...
instance
  ...
  LabelOptic "title" k (SomeActivityKey a) (SomeActivityKey a) x y
  where
  labelOptic =
    lens
      (\(MkSomeActivityKey a) -> a ^. #title)
      (\(MkSomeActivityKey a) b -> MkSomeActivityKey (set' #title b a))
